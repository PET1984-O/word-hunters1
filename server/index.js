...
const DICTS = {
  ...
  FLORES:      ['ROSA','LIRIO','TULIPAN','MARGARITA','GIRASOL','ORQUIDEA','CLAVEL','JAZMIN','DALIA','VIOLETA','AZUCENA','LAVANDA','HORTENSIA','AMAPOLA','BEGONIA','CAMELIA','GARDENIA','MAGNOLIA','PETUNIA','NARCISO','IRIS','PEONIA','GERANIO','AZALEA','GLADIOLO','BUGAMBILIA','CALA','CROCUS','HELECHO','MIMOSA'],
  NOMBRES_MASCULINOS: ['JUAN','PEDRO','LUIS','CARLOS','JOSE','MIGUEL','ANGEL','DIEGO','PABLO','JORGE','MARIO','RAUL','SERGIO','ANDRES','FERNANDO','RICARDO','ROBERTO','ALBERTO','MANUEL','DAVID','HECTOR','OSCAR','IVAN','MARTIN','ADRIAN','EMILIO','GABRIEL','HUGO','MARCO','DANIEL'],
  NOMBRES_FEMENINOS: ['MARIA','ANA','LAURA','SOFIA','LUCIA','PAULA','CARMEN','ELENA','TERESA','DIANA','CLARA','SANDRA','PATRICIA','GABRIELA','ANDREA','ISABEL','MARTA','ROSA','JULIA','CARLA','VALERIA','NATALIA','MONICA','LOURDES','BEATRIZ','ALEJANDRA','VERONICA','FABIOLA','ADRIANA','RENATA'],
  PELICULAS:   ['TITANIC','AVATAR','ROCKY','GLADIADOR','CASABLANCA','PSICOSIS','MATRIX','ALIEN','TIBURON','COCO','AMELIE','GREASE','FROZEN','MOANA','SHREK','DUMBO','BAMBI','PINOCHO','ENCANTO','CORALINE','MEMENTO','VERTIGO','SCARFACE','BATMAN','SUPERMAN','JOKER','CARS','RATATOUILLE','ZOOTOPIA','GODZILLA'],
  CARICATURAS_MEXICANAS: ['CHAVO','QUICO','KIKO','CHILINDRINA','CHAPULIN','POPIS','GODINEZ','JIRAFALES','BARRIGA','DONRAMON','FLORINDA','DONANIEVES','CANTINFLAS','MEMIN','VILLANOS','KARMALAND','HUEVOCARTOON','MARCIANITO','LUCHADORES','TELERIN','CRI CRI','TOPOGIGIO','BOMBERITO','CHOMPIRAS','CHILINDRINO','BOTIJA','CHAPARRON','PETERETE','ÑONO','PATADAS'],
  CANTANTES_FAMOSOS: ['SHAKIRA','LUISMI','THALIA','SELENA','JUANES','CHAYANNE','RICKY','BISBAL','ADELE','BEYONCE','MADONNA','PRINCE','ELVIS','SINATRA','MANA','CAMILO','KAROL','BADBUNNY','MALUMA','ROSALIA','PAUSINI','SERRAT','SABINA','JUANGABRIEL','VICENTE','BELINDA','ALEJANDRO','NATALIA','ARIANA','DRAKE'],
  CUERPO_HUMANO: ['CEREBRO','CORAZON','PULMON','HIGADO','RIÑON','ESTOMAGO','HUESO','MUSCULO','PIEL','SANGRE','VENAS','ARTERIA','COLUMNA','CRANEO','COSTILLA','RODILLA','CODO','MANO','PIE','OJO','OREJA','NARIZ','BOCA','LENGUA','DIENTE','CABELLO','BRAZO','PIERNA','CUELLO','ESPALDA'],
  NOVELAS_LITERARIAS: ['QUIJOTE','RAYUELA','PEDROPARAMO','CIENANOS','ULISES','MADAMEBOVARY','MOBYDICK','DRACULA','FRANKENSTEIN','ELPROCESO','LAPESTE','LASELVA','CORONEL','SIDDHARTA','ANA Karenina','MISERABLES','CRIMEN','CASTILLO','REBECA','FICCIONES','TUNEL','COMALA','NIEBLA','DOÑABARBARA','LA ILIADA','ODISEA','HAMLET','MACBETH','OTELLO','FAUSTO'],
  UNIVERSO: ['GALAXIA','PLANETA','ESTRELLA','COMETA','ASTEROIDE','METEORO','NEBULOSA','ORBITA','COSMOS','LUNA','SOL','MARTE','VENUS','JUPITER','SATURNO','URANO','NEPTUNO','PLUTON','MERCURIO','ECLIPSE','QUASAR','PULSAR','SUPERNOVA','AGUJERO','GRAVEDAD','CONSTELACION','SATELITE','ASTRONAUTA','TELESCOPIO','UNIVERSO']
};

const CAT_NAMES = Object.keys(DICTS);
const BOARD_THEMES = [
  { bg: '#1e293b', cell: '#334155', text: '#cbd5e1', border: '#475569' },
  { bg: '#164e63', cell: '#155e75', text: '#cffafe', border: '#22d3ee' },
  { bg: '#3b2f12', cell: '#574112', text: '#fef3c7', border: '#f59e0b' },
  { bg: '#14532d', cell: '#166534', text: '#dcfce7', border: '#22c55e' },
  { bg: '#3b0764', cell: '#581c87', text: '#f3e8ff', border: '#c084fc' },
  { bg: '#7f1d1d', cell: '#991b1b', text: '#fee2e2', border: '#f87171' },
  { bg: '#0f3b36', cell: '#115e59', text: '#ccfbf1', border: '#2dd4bf' }
];
const EXTRA_DICTS = {
  NEGOCIOS: ['CLIENTE','CAPITAL','MERCADO','RIESGO','AHORRO','CREDITO','NOMINA','IMPUESTO','UTILIDAD','INVERSION','PRODUCTO','SERVICIO','ALIANZA','GERENTE','RECURSO','GANANCIA','PERDIDA','BALANCE','FACTURA','CONTRATO','PROYECTO','EMPRESA','NEGOCIO','MONEDA','CHEQUE','CARTERA','BANCO','ACCION','DIVISA','SUBASTA'],
  ANIMALES: ['CABALLO','CONEJO','ARDILLA','DELFIN','BALLENA','TORTUGA','IGUANA','SERPIENTE','COBRA','RINOCERONTE','HIPOPOTAMO','ELEFANTE','CANGURO','GORILA','MONO','OVEJA','CABRA','VACA','GALLO','PATO','GANSO','FOCA','MORSA','PINGUINO','KOALA','LEMUR','HIENA','RANA','SAPO','CISNE'],
  PAISES: ['ESPAÑA','PORTUGAL','ALEMANIA','HOLANDA','BELGICA','DINAMARCA','FINLANDIA','ISLANDIA','IRLANDA','ESCOCIA','BOLIVIA','URUGUAY','PARAGUAY','ECUADOR','COLOMBIA','PANAMA','CUBA','HAITI','MARRUECOS','ARGELIA','KENIA','NIGERIA','GHANA','COREA','VIETNAM','TAILANDIA','ISRAEL','QATAR','FILIPINAS','MALASIA'],
  DEPORTES: ['BASQUET','HANDBALL','PATINAJE','CLAVADOS','TRIATLON','MARATON','SOFTBOL','BILLAR','BOLICHE','AJEDREZ','PESCA','VELA','CANOTAJE','ESCALADA','GIMNASIA','TAEKWONDO','BADMINTON','SQUASH','LACROSSE','CURLING','SKATE','HALTEROFILIA','PENTATLON','MOTOCROSS','AUTOMOVIL','PARACAIDISMO','ALPINISMO','SENDERISMO','AEROBICS','FRONTON'],
  COLORES: ['MAGENTA','LILA','OLIVO','CREMA','MARFIL','CORAL','SALMON','MENTA','LAVANDA','CAOBA','AMBAR','BRONCE','GRANATE','CARMESI','PERLA','JADE','ESMERALDA','RUBI','ZAFIRO','AÑIL','PIZARRA','HUESO','ARENA','LIMON','MALVA','ORO','PLATA','ACERO','CARMIN','VERDOSO'],
  FRUTAS: ['MANZANA','NARANJA','PIÑA','TORONJA','LICHI','MORA','MAMEY','ZAPOTE','NISPERO','MEMBRILLO','CHIRIMOYA','MARACUYA','GUANABANA','TUNA','PITAYA','DATIL','ACEROLA','NECTARINA','POMELO','CAQUI','GROSELLA','ARANDANO','MANGOSTAN','RAMBUTAN','CARAMBOLA','JICAMA','PEPINO','AGUACATE','ACEITUNA','CHABACANO'],
  PROFESIONES: ['ENFERMERO','VETERINARIO','CARPINTERO','ELECTRICO','PLOMERO','PANADERO','CARNICERO','MESERO','BARBERO','ESCRITOR','POETA','PINTOR','ESCULTOR','DISEÑADOR','PROGRAMADOR','ANALISTA','ECONOMISTA','PSICOLOGO','TERAPEUTA','NUTRIOLOGO','FARMACEUTICO','BIOQUIMICO','MARINERO','MECANICO','CONDUCTOR','JARDINERO','SECRETARIO','EDITOR','LOCUTOR','PERIODISTA'],
  TECNOLOGIA: ['PROCESADOR','MONITOR','IMPRESORA','ESCANER','ALTAVOZ','MICROFONO','AUDIFONO','CONSOLA','SOFTWARE','HARDWARE','SISTEMA','ARCHIVO','CARPETA','VENTANA','NAVEGADOR','INTERNET','SATELITE','FIBRA','MODEM','PUERTO','DOMINIO','USUARIO','CLAVE','CIFRADO','ALGORITMO','PAGINA','APP','RED','DATOS','FIREWALL'],
  MUSICA: ['MELODIA','RITMO','ARMONIA','CORO','VERSO','NOTA','ESCALA','ACORDE','SONATA','SINFONIA','OPERA','BALADA','BOLERO','CUMBIA','SALSA','TANGO','JAZZ','BLUES','REGGAE','ROCK','POP','RAP','TENOR','SOPRANO','BAJO','BARITONO','ORQUESTA','BANDA','CANTANTE','DIRECTOR'],
  CIENCIA: ['MOLECULA','GRAVEDAD','GENOMA','BACTERIA','VIRUS','TEORIA','HIPOTESIS','METODO','DATACION','FOSIL','MINERAL','CRISTAL','MAGNETO','VOLTAJE','AMPERIO','FRECUENCIA','ONDA','SONIDO','LUZ','PRISMA','VACUNA','PROTEINA','HORMONA','TEJIDO','ORGANO','SANGRE','NEBULOSA','GALAXIA','PLANETA','COMETA'],
  HISTORIA: ['RENACER','BARROCO','REVOLUCION','CONQUISTA','BATALLA','TRATADO','CORONA','REINO','EMPERADOR','PRINCIPE','ESCLAVO','NOMADA','IMPRENTA','BRONCE','MEDIEVAL','BIZANCIO','ESPARTA','ATENAS','ROMA','CARTAGO','PERSIA','FENICIO','OLMECA','TOLTECA','MIXTECA','ZAPOTECA','VIRREY','ARCHIVO','CRONICA','MUSEO'],
  NATURALEZA: ['MONTAÑA','COLINA','VALLE','RIO','CASCADA','CUEVA','ISLA','PLAYA','BAHIA','GOLFO','PRADERA','HUMEDAL','ARROYO','CAÑON','DUNA','AURORA','NIEBLA','LLUVIA','GRANIZO','RELAMPAGO','TRUENO','BRISA','HURACAN','CICLON','MAGMA','LAVA','ROCA','ARENA','MANGLE','PALMERA'],
  COCINA: ['HORNO','SARTEN','CUCHARA','CUCHILLO','TENEDOR','PLATO','VASO','TAZA','OLLA','COMAL','LICUADORA','BATIDORA','COLADOR','SALSA','QUESO','PAN','TORTILLA','FRIJOL','LENTEJA','GARBANZO','POLLO','CARNE','PESCADO','CAMARON','HUEVO','LECHE','CREMA','CHILE','AJO','CEBOLLA'],
  ROPA: ['SUETER','CHAMARRA','CHAQUETA','PLAYERA','SHORTS','CALCETIN','BOTAS','SANDALIA','TENIS','GORRA','BOINA','REBOZO','PAÑUELO','BATA','DELANTAL','UNIFORME','MALLA','LEOTARDO','SACO','BLAYZER','CAMISETA','CHAMPA','MEDIAS','ARETES','COLLAR','ANILLO','PULSERA','BROCHE','MOCHILA','BOLSO'],
  TRANSPORTE: ['AUTOBUS','AUTOMOVIL','TRACTOR','REMOLQUE','CARRETA','PATINETA','MONOPATIN','AMBULANCIA','PATRULLA','GRUA','AVIONETA','JET','VELERO','YATE','CRUCERO','CARGUERO','FERROCARRIL','LOCOMOTORA','VAGON','AERONAVE','DIRIGIBLE','MONTACARGA','SCOOTER','TRAILER','BULDOZER','EXCAVADORA','TRICICLO','MOTONETA','CARROZA','TROLEBUS']
};
Object.entries(EXTRA_DICTS).forEach(([cat, words]) => {
  DICTS[cat] = [...new Set([...(DICTS[cat] || []), ...words])];
});
...
function freshState() {
  return {
    phase: 'LOBBY',
    config: { rounds: 3, category: 'ALEATORIO', timePerRound: 300, tournamentName: defaultTournamentName(), boardTheme: BOARD_THEMES[0] },
...
function hashText(text) {
  return String(text || '').split('').reduce((acc, ch) => ((acc * 31) + ch.charCodeAt(0)) >>> 0, 7);
}

function boardThemeFor(tournamentName, category) {
  return BOARD_THEMES[hashText(`${tournamentName}|${category}`) % BOARD_THEMES.length];
}
...
io.on('connection', socket => {
  ...
  socket.on('start', cfg => {
    ...
    G.config = {
      rounds: Math.max(1, Math.min(3, +cfg.rounds || 3)),
      category: cat,
    ...
    G.config.boardTheme = boardThemeFor(G.config.tournamentName, G.config.category);
